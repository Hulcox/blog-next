...
-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_authorCommentId_fkey" FOREIGN KEY ("authorCommentId") REFERENCES "Profile"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
